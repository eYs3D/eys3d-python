...
struct ZdTable {
    // table[disparity_index] = Z in millimeters. Disparity index is the
...
// a byte buffer of big-endian uint16 millimeter values, widened to
...
// Convert a Q4 disparity (raw_disparity << 4) to Z in millimeters.
